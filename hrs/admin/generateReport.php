	...
	<div class="section-page">
    	<div class="wrapper">
        	...
        	<div class="aside-left" style="margin-left: 200px;float:none;padding-bottom:50px;">
               	<!-- START-ABOUT-US-->
                <div class="about-us">
                	<h2 style="font-family:Verdana, Geneva, sans-serif; font-style:normal;text-align:center;">Report Preview</h2>                </div>
                <!-- END-ABOUT-US-->
                <table id="mytable">
                    <tr>
                        <td id="label">Name</td>   
                    ...
                    <tr>
                        ...
                        <td><?php echo '<a href=viewreservation.php?id=' . $data["userId"] . '>' . 'Preview' . '</a>'; ?></td>
                    </tr>   
                    <?php 
                        }
                            ?>
